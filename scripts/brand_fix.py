...
p=Path("src/components/Reports.tsx")
s=p.read_text()

def once(old,new):
    global s
    if old not in s:
        raise SystemExit("expected Reports.tsx fragment not found: "+old[:120])
